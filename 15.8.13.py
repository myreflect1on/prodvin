...
# m =[]
# for i in mixed_list:
#     if set(str(i)).issubset('0123456789'):
#         m.append(str(i))
# m = sorted(filter(lambda x: str(x) if set(str(x)).issubset('0123456789') else None, mixed_list))
print(max(filter(lambda x: set(str(x)).issubset('0123456789'), mixed_list)))
# print(m)